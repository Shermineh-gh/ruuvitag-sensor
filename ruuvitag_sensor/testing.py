...
class MyRuuvi():
    ...
    def print_to_shell(self):
        ...
        print('-'*30)
        print('Temperature:\t{:.2f}\t¡ÆC'.format(self.temp))
        ...
        print('-'*30)
        print('Elevation X:\t{:.0f}\t¡Æ'.format(self.elev_x))
        print('Elevation Y:\t{:.0f}\t¡Æ'.format(self.elev_y))
        print('Elevation Z:\t{:.0f}\t¡Æ'.format(self.elev_z))
        print('-' * 30)
